...
public class ConfirmationPageTest extends TestBase{
	...
	public void ConfirmationPageTitleTest() {
		String title = confirmationPage.validateConfirmationPageTitle();
		Assert.assertEquals(title, "Order confirmation - My Store");
	}
	
	@Test(priority=2)
	public void ConfirmationPageValidateTest() {
		boolean flag = confirmationPage.validateConfirmationPage();
		Assert.assertTrue(flag);
	}
	
	
	@Test(priority=3)
	public void BackToOrderHistoryTest() {
